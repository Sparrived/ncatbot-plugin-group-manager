...
[![Version](https://img.shields.io/badge/version-1.0.2-post3-orange.svg)](https://github.com/Sparrived/ncatbot-plugin-group-manager/releases)
...
- ✅ **智能审核** - 基于 QQ 等级的入群申请自动审核,防止小号进群
- ✅ **禁言管理** - 支持对违规成员进行禁言处理,时长可自定义
- ✅ **头衔设置** - 为群成员设置专属头衔,彰显身份
...
| `/gm prefix <qq号\|@用户> <头衔>` | `qq号/@用户`：目标成员<br>`头衔`：要设置的专属头衔 | 为指定成员设置群专属头衔 | `/gm prefix 123456789 活跃成员`<br>`/gm prefix @某人 水群之王` |
